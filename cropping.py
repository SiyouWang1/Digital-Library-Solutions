...
folder = 'C:\\D\\DSU\\Dragomans\\types of pages we have'
save = 'C:\\D\\DSU\\Dragomans\\types of pages we have - copy'
error_folder = 'C:\\D\\DSU\\Kanagaratnam\\test_rotation\\75_Cropped'
...
def cut_borders(img_path, filename):
    ...
    try:
        ...
        image = image[border3:border4 + 1, border1:border2 + 1]
