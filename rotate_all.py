...
import os
import cv2
src = 'C:\\D\\DSU\\Kanagaratnam\\test_rotation\\Corrected\\train'
dst = 'C:\\D\\DSU\\Kanagaratnam\\test_rotation\\Corrected\\train'
            ...
            with Image.open(imgpath) as img:
                ...
                if orientation == 3:
                    ...
                    if filename.endswith(('JPEG', 'JPG', 'jpg', 'jpeg')):
                        ...
                        rotated_pil.save(save_path, quality=100, subsampling=0)
                    else:
